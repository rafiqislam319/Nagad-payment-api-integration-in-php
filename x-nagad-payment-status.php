...
if ($_GET['status']) {
    $config = [
        ...
        'NAGAD_APP_LOG' => '1',
        'NAGAD_APP_ACCOUNT' => '01844217310', //demo
        'NAGAD_APP_MERCHANTID' => '683002007104225', //demo
    ...
    $response = 'http://localhost/nagad/nagad-payment-status.php/demo-url';   //hard coded response url
    $responseArray = \Xenon\NagadApi\Helper::successResponse($response);
